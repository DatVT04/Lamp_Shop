    ...
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <head>
                    <title>${product.title} - Lamp Store</title>
                    ...
                    <style>
                        ...
                        .product-image-main {
                            ...
                            /* Trừ đi chiều rộng của thumbnail-container + gap */
                            height: 600px;
                            object-fit: cover;
                            border-radius: 12px;
            ...
            transform: scale(1.05);
                        ...
                        .thumbnail {
                            width: 100%;
                            /* Tràn hết chiều rộng của thumbnail-container */
                            height: 100px;
                            /* Chiều cao cố định */
                            object-fit: cover;
                                            ...
                                            <div class="options-col">
                                                <div
                                                    ...
                                                    <span class="ms-2">
                                                        ...
                                                        Hàng' : product.status.equals('inactive') ? 'Ngưng Bán' : 'Hết
                                                        Hàng'}
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="product-meta">
                                        <div class="meta-item">
                                            <strong>Danh Mục:</strong> <a
                                                href="listproduct?category=${product.categoryId}">${categoryName}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="filter-buttons">
                                                <a class="btn btn-outline-secondary me-2"
                                                    href="productdetail?id=${product.id}#feedback_section">Tất Cả</a>
                                                <a class="btn btn-outline-secondary me-2"
                                                    href="productdetail?id=${product.id}&filterStar=5#feedback_section"
                                                    onclick="${fiveStarCount > 0 ? 'return true;' : 'return false;'}">5
                                                    Sao (${fiveStarCount})</a>
                                                <a class="btn btn-outline-secondary me-2"
                                                    href="productdetail?id=${product.id}&filterStar=4#feedback_section"
                                                    onclick="${fourStarCount > 0 ? 'return true;' : 'return false;'}">4
                                                    Sao (${fourStarCount})</a>
                                                <a class="btn btn-outline-secondary me-2"
                                                    href="productdetail?id=${product.id}&filterStar=3#feedback_section"
                                                    onclick="${threeStarCount > 0 ? 'return true;' : 'return false;'}">3
                                                    Sao (${threeStarCount})</a>
                                                <a class="btn btn-outline-secondary me-2"
                                                    href="productdetail?id=${product.id}&filterStar=2#feedback_section"
                                                    onclick="${twoStarCount > 0 ? 'return true;' : 'return false;'}">2
                                                    Sao (${twoStarCount})</a>
                                                <a class="btn btn-outline-secondary me-2"
                                                    href="productdetail?id=${product.id}&filterStar=1#feedback_section"
                                                    onclick="${oneStarCount > 0 ? 'return true;' : 'return false;'}">1
                                                    Sao (${oneStarCount})</a>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <c:if test="${not empty feedback.replies}">
                                                    <c:forEach items="${feedback.replies}" var="reply">
                                                        <div class="reply" style="margin-left: 40px; margin-top: 10px;">
                                                            <div class="feedback-author">Lamp Shop</div>
