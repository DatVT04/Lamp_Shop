            ...
            <div class="sign-in">
                <form action="login" method="post">
                    ...
                    <div class="social-container">
                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid &redirect_uri=http://mocdang.com/login&response_type=code&client_id=634017246561-nm8fa8tdkoiq87jp0qubtuce77mnv2n5.apps.googleusercontent.com&approval_prompt=force" class="social"><i class="fab fa-google-plus-g"></i></a>
                    </div>
